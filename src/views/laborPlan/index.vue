<template>
    <div class="app-container">
        ...
        <!-- 查看详细弹出框 -->
        <el-dialog v-model="data.laborPlaneDetailsDialogVisibale" title="劳动计划" width="90%" style="height: 100%;" draggable
            ...
            <div class="baseInfo">
                ...
                <el-container>
                    <el-form inline ref="form1" :rules="rule1" :model="detailParams">
                        <el-form-item label="劳动计划等级" label-width="100" prop="ranks">
                            <el-select v-model="detailParams.ranks" placeholder="请选择" :disabled="!data.isAdding">
                                <el-option v-for="item in options.ranks" :key="item" :label="item.label"
                                    :value="item.value"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="学期" label-width="70" prop="termName">
                        ...
                        <el-form-item label="年级" label-width="70" prop="grade">
                        ...
                        <el-form-item label="指导老师" label-width="70" prop="mentorName">
                            <el-input v-model="detailParams.mentorName" placeholder="请输入"
                                :disabled="!data.isAdding"></el-input>
                        </el-form-item>
                        <el-form-item label="指导老师工号" label-width="100" prop="mentor">
                            <el-input v-model.number="detailParams.mentor" placeholder="请输入"
                                :disabled="!data.isAdding"></el-input>
                        </el-form-item>
                        <el-form-item label="院系" label-width="70" prop="deptName">
                        ...
                        <el-form-item label="期限" label-width="70" prop="deadline">
            ...
            <div class="labor-context">
                ...
                <el-form :model="detailParams" :rules="rule2" ref="form2" label-position="left" label-width="150px">
