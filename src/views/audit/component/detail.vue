        ...
        <div class="selfInfoItem">
          ...
          <span>
              <el-select style="width: 150px" v-model="personalQueryParams.term"
                         @change="getRecordList2({userId:data.peronalInfo.userId,term:personalQueryParams.term,laborKind: -1})">
      ...
      <el-row style="height: 100%">
        ...
        <el-col :span="5">
          <div class="aside">
            ...
            <div class="aside-item" @click="getRecordList(data.peronalInfo.userId)">
              全部
            </div>
        ...
        <el-col :span="19">
          <div class="main">
            <el-table :data="list" stripe>
              ...
              <el-table-column label="类型" align="center" prop="laborKindName"></el-table-column>
    ...
    <el-dialog draggable v-model="data.makeGradeDialogVisible" title="评分" width="30%" :before-close="closeMakeGrade">
      ...
      <el-form label-position="left">
        <el-form-item label="分数">
          <el-select v-model="data.peronalInfo.score" class="audit-select" placeholder="请选择等级" size="default">
...
import {
  ...
  makePersonalGrade,
  getLaborRecordList,
  getLaborRecordDetail, getLaborRecordList2,
} from "@/api/audit";
...
const getList = () => {
  //TODO: 写死的id因为 别人的id没有信息 获取个人信息
  getPersonalAuditList(id.value).then(res => {
    // console.log(res.data)
    data.peronalInfo = res.data;
    //获取列表
    //TODO: 同理没有其他ID
    getRecordList(data.peronalInfo.userId);
  })
}
getList();
...
const getRecordList = (query) => {
  getLaborRecordList(query).then(res => {
    ...
    data.list.forEach((ele) => {
      ...
      ele.laborKindName = kindOption.value[ele.laborKind];
    })
  })
}
...
const toggleCategory = (category) => {
  ...
  getRecordList2({
    userId: data.peronalInfo.userId,
    term: personalQueryParams.value.term === "" ? -1 : personalQueryParams.value.term,
    laborKind: category,
  });
}
